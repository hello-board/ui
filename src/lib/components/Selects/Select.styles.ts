...
>({
  ...
  return {
    control: (base: CSSObjectWithLabel, { isFocused, isDisabled }) => ({
      ...
      minHeight: controlMinHeight ? controlMinHeight : size === 'md' ? '40px' : '32px',
      ...
      borderRadius: controlBorderRadius ? controlBorderRadius : '8px',
      boxShadow: controlBoxShadow ? controlBoxShadow : 'none',
      paddingLeft: '0',
      fontSize: '14px',
      '&:hover': isHovered &&
        !isFocused && {
